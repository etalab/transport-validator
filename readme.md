...
| feed_contact_email     | map             | Gives the feed contact email, read from `feed_info.txt`, for each feed publisher name. For example: `{"agency name 1": "contact@example.com"}` |
| feed_start_date     | map             | Gives the feed start email, read from `feed_info.txt`, for each feed publisher name. For example: `{"agency name 1": "2025-02-20"}` |
| feed_end_date     | map             | Gives the feed end email, read from `feed_info.txt`, for each feed publisher name. For example: `{"agency name 1": "2025-02-20"}` |
